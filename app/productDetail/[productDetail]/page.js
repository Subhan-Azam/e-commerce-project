...
// import RemoveFromCartBtn from "@/app/(components)/removeFromCartBtn/RemoveFromCartBtn";

// export default function Page({ params }) {
//   const [product, setProduct] = useState(null);
//   const [cartData, setCartData] = useState();
//   const [storedCart, setStoredCart] = useState(JSON.parse(localStorage.getItem('cart')))
//   const [cartIds, setCartIds] = useState(()=>storedCart.map((item)=>{
//     return item._id
//   }))
